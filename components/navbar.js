    ...
    <nav className="navbar">
      ...
      <div className="navbar__right_span">
        ...
        {/* {menuClicked ? (
          ...
          <div className="navbar__menu w-4" onClick={toggleMenuClick}>
            <svg viewBox="0 0 286 256" fill="#594949" alt="menu burger">
              <path d="M0.108387 129.097C0.695413 120.973 7.77467 114.395 15.9201 114.406L271.558 114.753C279.703 114.764 285.83 121.359 285.243 129.483C284.656 137.607 277.578 144.184 269.432 144.173L13.794 143.827C5.64931 143.815 -0.477957 137.221 0.108387 129.097Z" />
              <path d="M0.108387 240.097C0.695413 231.973 7.77467 225.395 15.9201 225.406L271.558 225.753C279.703 225.764 285.83 232.359 285.243 240.483C284.656 248.607 277.578 255.184 269.432 255.173L13.794 254.827C5.64931 254.815 -0.477957 248.221 0.108387 240.097Z" />
